...
import com.example.petbuddyproject.databinding.ActivityHealthBinding
...
class HealthActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnHealthBackToHome.setOnClickListener {
            val intent = Intent(this, MainActivity::class.java)
            startActivity(intent)
        }
        binding.btnGoToWeightAct.setOnClickListener {
